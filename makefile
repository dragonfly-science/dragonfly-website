...
develop: website
	$(RUN) bash -c 'make -C front-end NPM="run build:dev" npm & (make -C front-end NPM="run watch:css" npm) & (make -C front-end SHOWCONTROLS=1 NPM="run watch:js" npm) & (cd content && ../website watch)'
